...
$duplicate_email_query="select * from ecommerce.users where email='$email'";
...
$password=md5($passwd);
$user_registration_query="insert into ecommerce.users (email,name,phone,password) values ('$email','$name','$phone','$password')";
